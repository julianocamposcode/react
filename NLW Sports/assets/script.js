...
if (ignite.textContent == 'Explorer') {
	
	ignite.parentElement.href = '../explorer/primeiro_passo.html'
}else {
	ignite.parentElement.href = '../ignite/iniciando.html'
}


console.log(ignite.parentElement)
